    ...
    public partial class AddDocumentManagement : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DocumentActivityLogId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    DocumentId = table.Column<int>(type: "INTEGER", nullable: false),
                    UserId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentActivityLogs", x => x.DocumentActivityLogId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedWithProjectId = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentActivityLogs_Timestamp",
                table: "DocumentActivityLogs",
                column: "Timestamp");
